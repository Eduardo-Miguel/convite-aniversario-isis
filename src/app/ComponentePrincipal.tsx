  ...
  return (
    <div className="flex flex-col">
      <div className="relative min-w-60">
        ...
        >
          <source src="/convite_de_aniversario_rosa_delicado.mp4" type="video/mp4" />
        </video>
        ...
        {abriuSugestoes && (
          <div onClick={handleSugestoes}>
            <img className="z-40 absolute top-0" src="/sugestoes.png" alt="" width={396} height={558} />
            <div className="z-50 absolute bottom-14 right-10 text-center font-black cursor-pointer">
      ...
      <div
        className={`mt-2 flex justify-between h-28
          transition-opacity duration-1000 ${abriuConvite ? "opacity-100" : "opacity-0"}`}
      >
        <a
          href="https://wa.me/5567992227298?text=Oiiii%2C%20passando%20para%20confirmar%20presen%C3%A7a%20na%20festa%20da%20Isis%21"
        ...
        <a
          href="https://maps.app.goo.gl/Akmk5sSYn2CxcxZD9"
          className="flex-1 flex flex-col border justify-center items-center text-center"
        >
